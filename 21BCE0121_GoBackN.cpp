...
void receiver() {
    ...
    while (true) {
        ...
        // Simulate random acknowledgment loss
        if (rand() % 10 < 3) {
            cout << "Acknowledgment for packet with sequence number " << expectedSequenceNumber << " lost!" << endl;
            continue;
        }
        ...
        cout << "Sending acknowledgment for packet with sequence number " << expectedSequenceNumber << endl;
